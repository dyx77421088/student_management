...
class DYXPullToRefreshGif extends StatefulWidget {
  @override
  _DYXPullToRefreshGifState createState() => _DYXPullToRefreshGifState();
}

class _DYXPullToRefreshGifState extends State<DYXPullToRefreshGif> {
  @override
...
class GifHeader1State extends RefreshIndicatorState<GifHeader1>
  ...
  Future<void> endRefresh() {
    ...
    return _gifController.animateTo(39, duration: Duration(milliseconds: 500));
  }
  ...
  Widget buildContent(BuildContext context, RefreshStatus mode) {
    ...
    return Container(
      ...
      color: Colors.white,
      child: GifImage(
        image: AssetImage("assets/images/shuijiao.gif"),
