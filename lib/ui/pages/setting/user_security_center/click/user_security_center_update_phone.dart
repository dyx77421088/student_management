...
import 'package:student_management/core/services/user/user_check_phone_number.dart';
...
class DYXUserSecurityCenterUpdatePhone extends StatelessWidget {
  ...
  void updatePhone(BuildContext context) {
    if(formKey.currentState.validate()) {
      // 检测手机号是否已经注册
      DYXUserCheckPhoneNumber.checkPhoneNumber(_phoneController.text).then((value){
