...
import 'package:flutter_cupertino_date_picker/flutter_cupertino_date_picker.dart' as pi;
...
class _DatePickerBottomSheetState extends State<DatePickerBottomSheet> {
  ...
  pi.DateTimePickerLocale _locale = pi.DateTimePickerLocale.en_us;
  List<pi.DateTimePickerLocale> _locales = pi.DateTimePickerLocale.values;
  ...
  void _showDatePicker() {
    pi.DatePicker.showDatePicker(
      context,
      onMonthChangeStartWithFirstDate: true,
      pickerTheme: pi.DateTimePickerTheme(
